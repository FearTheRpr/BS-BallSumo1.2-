Shader "Hidden/Universal Render Pipeline/Terrain/WC_Lit (Basemap Gen)"
{
    Properties
    {
...
#else
              half4 Vert() : SV_Position { return float4(0,0,0,1); }
              half4 Frag() : SV_Target{ return float4(0,0,0,0); }
#endif
            ENDHLSL
        }
